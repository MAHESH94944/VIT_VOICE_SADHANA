...
export default function MonthlyReport() {
  ...
  const processedData = useMemo(() => {
    ...
    return {
      labels,
      wakeUp: getChartData("wakeUp", parseTimeToMinutes, true, 720),
      ...
      timeToBed: getChartData("timeToBed", parseTimeToMinutes, true, 1560),
      dayRest: getChartData("dayRest", parseDurationToMinutes, true, 120),
